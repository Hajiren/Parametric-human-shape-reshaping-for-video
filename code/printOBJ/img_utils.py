...
def mls_rigid_deformation_copy(image, p, q, alpha=1.0, density=1.0):
    ''' Rigid deformation
    ### Params:
        * image - ndarray: original image
        * p - ndarray: an array with size [n, 2], original control points
...
def mls_rigid_deformation_inv_copy(image, p, q, alpha=1.0, density=1.0):
...
def mls_rigid_deformation(image, p, q, vx, vy, alpha=1.0):
    ''' Rigid deformation
    ### Params:
        * image - ndarray: original image
        * p - ndarray: an array with size [n, 2], original control points
    ...
    # Removed the points outside the border
    transformers[transformers < 0] = 0
    transformers[1][transformers[1] > height - 1] = height
    transformers[0][transformers[0] > width - 1] = width
    
    return transformers



def mls_rigid_deformation_inv(image, p, q, vx, vy, alpha=1.0):
    ''' Rigid inverse deformation
    ### Params:
        * image - ndarray: original image
        * p - ndarray: an array with size [n, 2], original control points
